    ...
    <div className='h-96 sm:h-[100vh] w-[100vw] text-white bg-hero bg-cover sm:bg-auto bg-center'>
      <div className='h-[100%] w-[100%] bg-[rgba(0,0,0,0.9)]'>
        <div className='flex justify-end w-[100vw]'>
           <div className='bg-slate-50 w-16 h-16 rounded-full m-3'>
        ...
        <div className='flex m-5'>
            <button className='rounded-lg  bg-white text-black mx-2 p-3 sm:text-3xl'>Get Started</button>
            <button className='rounded-lg bg-white text-black mx-2 p-3 sm:text-3xl'>Learn how it works</button>
        </div>
        </div>
        </div>
    </div>
