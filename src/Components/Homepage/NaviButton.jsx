...
const Nbutton=({image})=>{
    return (
        <>
        <div data-tooltip-target="tooltip-right" data-tooltip-placement="right" className='h-16 w-16 rounded-full bg-[rgba(255,255,255,0.5)] m-2 flex items-center justify-center bg-cover cursor-pointer'>
